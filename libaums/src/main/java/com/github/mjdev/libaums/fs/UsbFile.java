...
public interface UsbFile extends Closeable {
     ...
     * @throws IOException If new name is already assigned or writing to the file system
     *                     fails.
     */
     ...
     *
     * @param offset      The offset in bytes where reading in the file should be begin.
     * @param destination Buffer the data shall be transferred to.
     * @throws IOException If reading fails.
     */
     ...
     *
     * @param offset The offset in bytes where writing in the file should be begin.
     * @param source Buffer which contains the data which shall be transferred.
     ...
     * @throws IOException If writing to the disk fails or a item with the same name
     *                     already exists.
     */
     ...
     *
     * @param destination The directory where this item should be moved.
     * @throws IOException If writing fails, or the operation cannot be done (eg. item
     ...
     *
     * @throws IOException If operation fails due to write errors.
     */
